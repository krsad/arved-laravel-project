                                    ...
                                    <div id="collapseTwo" class="panel-collapse collapse" data-parent="#accordion" role="tabpanel" aria-labelledby="headingTwo">
                                        <br><br>   <div class="panel-body">
                                            <div _ngcontent-c2="">
                                                ...
                                                </form><div _ngcontent-c2="" class="form-group">
                                                    <label _ngcontent-c2="" class="birimlerLabel">Öğretim Elemanı:</label>
                                                    <input _ngcontent-c2="" name="ogretim_elemani" value="{{ Auth::user()->name }}" class="textFull form-control ng-untouched ng-pristine ng-valid"   readonly type="text">
                                                ...
                                                <div _ngcontent-c2="" class="form-group">
                                                    ...
                                                    <input _ngcontent-c2="" name="isim" class="textFull form-control ng-untouched ng-pristine ng-valid" maxlength="100" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="text">
                                                </div>

                                                <div _ngcontent-c2="" class="form-group">
                                                    <label _ngcontent-c2="" class="birimlerLabel">Yazar Listesi:</label>
                                                    <input _ngcontent-c2="" name="yazarlar" value="{{Auth::user()->name}}" class="textFull form-control ng-untouched ng-pristine ng-valid" maxlength="100" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="text">
                                                </div>
                                                <div _ngcontent-c2="" class="form-group">
                                                ...
                                                <center><table class="table table-striped" style="width:100%" >
                                                        ...
                                                        @foreach($makales as $item)
                                                            @if ($item->yazarlar == Auth::user()->name)
...
@foreach($game as $item)
    @if ($item->wos_h_index == 1)

        <tr>
            <td>{{$item->ogretim_elemani}}</td>
                <td>{{$item->uzmanlik_alani}}</td>
            </tr>
